var tabledata = [
 ...
 //create Tabulator on DOM element with id "tabela_registro"
var tabela_registro = new Tabulator("#tabela_registro", {
 	height: "100%",
    data:tabledata, //assign data to table
 	layout:"fitColumns", //fit columns to width of table (optional)
 	columns:[ //Define Table Columns
	 	{title:"Data de Empréstimo", field:"data_empre", hozAlign:"center", width:120, headerWordWrap:true, headerSort: false},
